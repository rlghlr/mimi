...
type Item = { href: string; label: string; icon: string; preparing?: boolean };
...
const CUSTOMER: Item[] = [
  ...
  { href: "/app/chats", label: "채팅", icon: "M4 4h16v12H7l-3 3zM8 9h8M8 12h5", preparing: true },
...
const PRO: Item[] = [
  ...
  { href: "/pro/chats", label: "채팅", icon: "M4 4h16v12H7l-3 3zM8 9h8M8 12h5", preparing: true },
            ...
            <li key={it.href}>
              {it.preparing ? (
                <button type="button" className={cls}
                  onClick={() => alert("채팅은 현재 준비 중이에요. 곧 만나요!")}>
                  {inner}
                </button>
              ) : (
